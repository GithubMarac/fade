...
!function () {
    ...
    if ("undefined" == typeof DayPilot.$) {
        ...
        DayPilot.browser.ie9 = function () {
            ...
            return e.innerHTML = "<!--[if IE 9]><i></i><![endif]-->",
            1 === e.getElementsByTagName("i").length
        }
        (),
        DayPilot.browser.ielt9 = function () {
            var e = document.createElement("div");
            return e.innerHTML = "<!--[if lt IE 9]><i></i><![endif]-->",
            1 === e.getElementsByTagName("i").length
        }
        (),
        ...
        function () {
            if (!DayPilot.Global.defaultCss) {
                ...
                e.add(".month_default_event_inner", "position: absolute;top: 0px;bottom: 0px;left: 1px;right: 1px;overflow:hidden;padding: 2px;padding-left: 10px;color: #333;background: #fff;background: linear-gradient(to bottom, #ffffff 0%, #eeeeee);border: 1px solid #999;border-radius: 0px;display: flex; align-items: center; font-size: 13px;"),
        ...
        DayPilot.re = function (e, t, a) {
            a && e && e.addEventListener(t, a, !1)
        },
        DayPilot.rePassive = function (e, t, a) {
            a && e && e.addEventListener(t, a, {
                "passive": !0
            })
        },
        ...
        DayPilot.Duration = function (e) {
            ...
            if (2 === arguments.length) {
                ...
                "string" == typeof d && (d = new DayPilot.Date(d)),
                e = d.getTime() - i.getTime()
            }
            return this.ticks = e,
            DayPilot.Date.Cache.DurationCtor["" + e] ? DayPilot.Date.Cache.DurationCtor["" + e] : (DayPilot.Date.Cache.DurationCtor["" + e] = this, this.toString = function (e) {
                if (!e)
                    return t.days() + "." + t.hours() + ":" + t.minutes() + ":" + t.seconds() + "." + t.milliseconds();
                var a = t.minutes();
                a = (a < 10 ? "0" : "") + a;
                var r = e;
                return r = r.replace("mm", a),
                r = r.replace("m", t.minutes()),
                r = r.replace("H", t.hours()),
                r = r.replace("h", t.hours()),
                r = r.replace("d", t.days()),
                r = r.replace("s", t.seconds())
        ...
        DayPilot.Date.prototype.addMonths = function (e) {
            ...
            return o.setUTCDate(Math.min(n, t.getUTCDate())),
            new DayPilot.Date(o)
        },
        ...
        DayPilot.Date.prototype.addYears = function (e) {
            ...
            return a.setUTCDate(Math.min(n, t.getUTCDate())),
            new DayPilot.Date(a)
        },
        ...
        DayPilot.Date.prototype.weekNumberISO = function () {
            ...
            return o >= 4 && (i += 1),
            i > 52 && !e && (i = 1),
            0 === i && (i = this.firstDayOfYear().addDays(-1).weekNumberISO()),
            i
        },
        ...
        DayPilot.DateUtil.fromStringSortable = function (e, t) {
            ...
            if ("." === m) {
                ...
                y = DayPilot.DateUtil.getTzOffsetMinutes(e.substring(23))
            } else
                y = DayPilot.DateUtil.getTzOffsetMinutes(e.substring(19));
            var p = new DayPilot.Date(s);
            return t || (p = p.addMinutes(-y)),
            s = p.toDate(),
            DayPilot.Date.Cache.Parsing[e] = s,
            s
        },
        ...
        DayPilot.DateUtil.daysDiff = function (e, t) {
            if (e && t || function () {
                ...
                (), e = new DayPilot.Date(e), t = new DayPilot.Date(t), e.getTime() > t.getTime())
                return null;
        ...
        DayPilot.DateUtil.daysSpan = function (e, t) {
            ...
            return t.getTime() == t.getDatePart().getTime() && a--,
            a
        },
        ...
        var r = function (e, a) {
            ...
            this.findSequence = function (t) {
                ...
                return e.indexOf(t) === -1 ? null : {
                    "findValue": function (n) {
                        for (var i = o(e), d = null, l = 0; l < r.length; l++) {
                            var s = (r[l].length, t === r[l].seq),
                            u = r[l].expr;
                            s && (u = "(" + u + ")", d = r[l].transform),
                            i = i.replace(r[l].seq, u)
                        }
                        i = "^" + i + "$";
                        try {
                            var c = new RegExp(i),
            ...
            this.parse = function (e) {
                ...
                if (d < 0 || d > 59)
                    return null;
                var u = new Date;
                return u.setUTCFullYear(t, a - 1, r),
                u.setUTCHours(n),
                u.setUTCMinutes(i),
                u.setUTCSeconds(d),
...
(), DayPilot.JSON = {}, function () {
    ...
    function t(e) {
        ...
        i.test(e) ? '"' + e.replace(i, function (e) {
            var t = d[e];
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
        ...
        t.gMouseUp = function (i) {
            if (t.resizing) {
                ...
                DayPilot.Util.removeClass(t.moving, n.calendar.b("_event_moving_source"));
                var o = t.movingShadow.column;
                t.moving = null,
                t.movingShadow = null,
                n.calendar.nav.top.style.cursor = "auto",
                n.calendar.c(n, o, a, i)
            } else if (t.selecting && null !== t.topSelectedCell) {
                var r = t.selecting.calendar;
                t.selecting = !1;
                var h = r.getSelection();
                r.d(h.start, h.end, h.resource),
                "Hold" !== r.timeRangeSelectedHandling && "HoldForever" !== r.timeRangeSelectedHandling && e()
            } else
                t.selecting = !1
        },
        ...
        t.Calendar = function (e, i) {
            ...
            this.g = function () {
                DayPilot.de(s.elements.selection),
                s.elements.selection = [],
                s.nav.activeSelection = null
            },
            this.h = navigator && navigator.userAgent && navigator.userAgent.indexOf("MSIE") !== -1,
            ...
            this.r = function (e, t) {
                ...
                n.style.zIndex = 101,
                n.className = s.b("_shadow");
                var a = document.createElement("div");
                return a.className = s.b("_shadow_inner"),
                n.appendChild(a),
                i.firstChild.appendChild(n),
                n
            },
            this.s = {},
            this.s.locale = function () {
            ...
            this.m = function (e, t) {
                ...
                s.z(),
                s.A(),
                "Full" === e.UpdateType && (s.B(), s.C(), s.D(), s.E()),
                s.u(),
                s.F(),
                s.clearSelection(),
                s.afterRender(e.CallBackData, !0),
                s.loadingStop()
            },
            this.G = function () {
                return this.H() / 36e5
            ...
            this.H = function () {
                var e = 0;
                return e = "BusinessHoursNoScroll" === this.heightSpec ? this.I() : 24,
                60 * e * 60 * 1e3
            },
            this.K = function () {
            ...
            this.O = function (e) {
                ...
                if (i.e = t, i.preventDefault = function () {
                    this.preventDefault.value = !0
                }, "function" == typeof s.onEventRightClick && (s.onEventRightClick(i), i.preventDefault.value))
                    return !1;
                ...
                return "function" == typeof s.onEventRightClicked && s.onEventRightClicked(i),
            ...
            this.c = function (e, t, i, n) {
                ...
                h = e.end(),
                c = new Date;
                r instanceof DayPilot.Date && (r = r.toDate()),
                c.setTime(Date.UTC(r.getUTCFullYear(), r.getUTCMonth(), r.getUTCDate()));
            ...
            this.timeRangeSelectedPostBack = function (e, t, i, n) {
                ...
                s.start = e,
                s.end = t,
                this.i("TimeRangeSelected", n, s)
            },
            this.timeRangeSelectedCallBack = function (e, t, i, n) {
                var s = {};
                s.start = e,
                s.end = t,
                this.k("TimeRangeSelected", n, s)
            },
            ...
            this.R = function (e) {
                if (!t.selecting && "Disabled" !== s.timeRangeSelectedHandling) {
                    var i = e.which;
                    if (1 === i || 0 === i)
                        return t.firstMousePos = DayPilot.mc(e), t.selecting = {},
                ...
                a = function (e) {
                    ...
                    if (DayPilot.isArray(i)) {
                        ...
                        if (o.preventDefault = function () {
                            this.preventDefault.value = !0
                        }, o.data = i, "function" == typeof t && t(o), o.preventDefault.value)
                            return;
                        s.columns.list = i,
                        s.W && s.update()
                    }
            ...
            this.w = function () {
                var e;
                e = "Resources" !== s.viewType ? this.X() : s.columns.list,
                this.Q = [];
                for (var t = 0; t < e.length; t++) {
                    var i = this.Y(e[t]);
                    this.Q.push(i)
            ...
            this.X = function () {
                ...
                case "Week":
                    i = 7,
                    t = t.firstDayOfWeek(a.locale().weekStarts);
                    break;
                case "WorkWeek":
                    i = 5,
                    t = t.firstDayOfWeek(1)
                }
                ...
                for (var n = 0; n < i; n++) {
                    ...
                    o = {};
                    o.start = t.addDays(n),
                    o.name = o.start.toString(l, a.locale()),
                    e.push(o)
                }
                return e
            },
            ...
            this.Z = function (e) {
                ...
                a.onclick = this.M,
                DayPilot.re(a, "contextmenu", this.O),
                ...
                a.onmousedown = function (i) {
                    ...
                    if ("n-resize" !== this.style.cursor && "s-resize" !== this.style.cursor || 1 !== n) {
                        if (1 === n && e.client.moveEnabled()) {
                            ...
                            a.oldColumn = s.Q[this.data.part.dayIndex].id,
                            t.originalMouse = DayPilot.mc(i),
                            t.originalTop = this.offsetTop;
                            var l = DayPilot.mo3(this, i);
                            l ? t.moveOffsetY = l.y : t.moveOffsetY = 0,
                            s.nav.top.style.cursor = "move"
                        }
                    } else
                ...
                if (n.rows[0].cells[e.part.dayIndex]) {
                    n.rows[0].cells[e.part.dayIndex].firstChild.appendChild(a),
                    s.$(a)
                }
                        ...
                        for (var i = 0; i < t.blocks.length; i++)
                            for (var n = t.blocks[i], s = 0; s < n.lines.length; s++)
                                for (var a = n.lines[s], l = 0; l < a.length; l++) {
                                    var o = a[l];
                                    o.part.width = 100 / n.lines.length,
                                    o.part.left = o.part.width * s;
                                    var r = s === n.lines.length - 1;
                                    r || (o.part.width = 1.5 * o.part.width),
                                    this.Z(o)
                                }
                }
            },
            this._ = function () {
                ...
                DayPilot.Util.addClass(this.nav.top, this.b("_main")),
                ...
                this.nav.scroll.style.height = this.aa() + "px",
            ...
            this.ca = function () {
                ...
                return s.style.position = "relative",
                i.appendChild(s),
                s.appendChild(this.ea()),
                s.appendChild(this.fa()),
                e.appendChild(t),
                this.nav.zoom = e,
                e
            },
            ...
            this.fa = function () {
                ...
                for (var t = this.Q, i = t.length, n = e.insertRow(-1), a = 0; a < i; a++) {
                    ...
                    s.rtl || (l.style.textAlign = "left");
                    var o = document.createElement("div");
                    o.style.marginRight = s.columnMarginRight + "px",
            ...
            this.ga = function (e, t) {
                ...
                var o = document.createElement("div");
                o.style.position = "relative",
                o.className = this.b("_rowheader"),
                o.style.width = this.hourWidth + "px",
                o.style.height = i + "px",
                o.style.overflow = "hidden",
                o.unselectable = "on";
                var r = document.createElement("div");
                r.className = this.b("_rowheader_inner"),
                r.unselectable = "on";
                ...
                u = d < 12,
                v = a.timeFormat();
                "Clock12Hours" === v && (d %= 12, 0 === d && (d = 12)),
                h.innerHTML = d;
                var p = document.createElement("span");
                p.unselectable = "on",
                p.className = this.b("_rowheader_minutes");
                var f;
                f = "Clock12Hours" === v ? u ? "AM" : "PM" : "00",
                p.innerHTML = f,
                h.appendChild(p),
                r.appendChild(h),
                o.appendChild(r),
            ...
            this.ba = function () {
                ...
                if (n.appendChild(this.nav.header), a) {
                    ...
                    l.className = this.b("_cornerright");
                    var o = document.createElement("div");
                    o.className = this.b("_cornerright_inner"),
                    l.appendChild(o),
                    n.appendChild(l),
                    this.nav.cornerRight = l
                }
            ...
            this.ia = function () {
                ...
                var t = document.createElement("div");
                return t.unselectable = "on",
                t.className = this.b("_corner_inner"),
                e.appendChild(t),
                e
            },
            this.o = function () {
            ...
            this.C = function () {
                ...
                for (var l = a.length, r = o.insertRow(-1), h = 0; h < l; h++) {
                    ...
                    s.rtl || (c.style.textAlign = "left");
                    var d = document.createElement("div");
                    d.style.marginRight = s.columnMarginRight + "px",
                ...
                s.nav.scrollable.onmousemove = function (e) {
                    ...
                    if (t.resizing) {
                        ...
                        c + v > h && (c = h - v),
                        DayPilot.Util.addClass(t.moving, s.b("_event_moving_source")),
                        ...
                        f < 0 && (f = 0),
                        f < u.rows[0].cells.length && f >= 0 && t.movingShadow.column !== f && (t.movingShadow.column = f, t.moveShadow(u.rows[0].cells[f]))
                    } else if (t.selecting) {
                        var n = DayPilot.mc(e),
                        g = s.V.getCellCoords(),
                        m = t.column,
                        y = s.nav.main.rows[g.y].cells[m];
                        n.y < t.firstMousePos.y ? (t.selectedCells = t.getCellsBelow(y), t.topSelectedCell = t.selectedCells[0], t.bottomSelectedCell = t.firstSelected) : (t.selectedCells = t.getCellsAbove(y), t.topSelectedCell = t.firstSelected, t.bottomSelectedCell = t.selectedCells[0]),
                        s.S()
                    }
                },
            ...
            this.ka = function (e) {
                for (var t = e ? this.nav.header.insertRow(-1) : this.nav.header.rows[0], i = this.Q, n = i.length, a = 0; a < n; a++) {
                    ...
                    o.style.height = this.headerHeight + "px",
                    o.onclick = s.la;
                    ...
                    if (e) {
                        ...
                        r.className = s.b("_colheader"),
                        r.style.height = this.headerHeight + "px",
                        s.headerTextWrappingEnabled || (r.style.whiteSpace = "nowrap");
                        var h = document.createElement("div");
                        h.className = s.b("_colheader_inner"),
                        h.unselectable = "on",
                        r.appendChild(h),
                        o.appendChild(r)
                    }
            ...
            this.la = function (e) {
                if ("Disabled" !== s.headerClickHandling) {
                    ...
                    n.header = {},
                    n.header.id = t.id,
                    n.header.name = t.name,
                    n.header.start = t.start,
                    n.column = i,
                    n.originalEvent = e,
                    n.shift = e.shiftKey,
                    n.ctrl = e.ctrlKey,
            ...
            this.ua = function () {
                if (s.nav.top.className !== s.b("_main")) {
                    ...
                    var e = s.nav.corner;
                    e.className = s.b("_corner"),
                    e.firstChild.className = s.b("_corner_inner");
                            ...
                            if (!n[v]) {
                                ...
                                if (!(m < g)) {
                                    ...
                                    if ("Resources" === s.viewType && (y = y && r.id === l.resource), y) {
                                        ...
                                        b.part.dayIndex = a,
                                        b.part.start = c < g ? l.start : h,
                                        b.part.end = u > m ? l.end : d;
                                        ...
                                        b.part.height = Math.max(Math.ceil(k / this.cellHeight) * this.cellHeight - b.part.top, this.cellHeight - 1) + 1,
                                        ...
                                        r.events.push(b),
                                        "function" == typeof this.onBeforeEventRender && (b.cache = this.Ba.events[v]),
            ...
            this.getPixels = function (e, t) {
                ...
                c.top = this.Ea(l),
                c.boxTop = this.Ea(r),
                c.boxBottom = this.Ea(h),
                this.cache.pixels[n + "_" + i] = c,
                c
            },
            this.Ea = function (e) {
            ...
            this.Ia = function () {
                this.ra.themes = [],
                this.ra.themes.push(this.theme || this.cssClassPrefix)
            },
            this.Ja = function () {
            ...
            this.internal = {},
            this.internal.loadOptions = s.va,
            this.internal.xssTextHtml = s.ma,
            this.init = function () {
                this.Aa();
                var e = this.Fa();
                return this.Ia(),
                e ? void this.Ga() : (this.wa(), this.w(), this.z(), this._(), this.B(), this.C(), this.u(), this.sa(), this.pa(), this.ta(), t.register(this), this.events && (this.A(), this.F()), this.Ka(), this.La(), this.Ha(), this.W = !0, this)
            },
            this.Init = this.init,
            this.va(i)
        },
    ...
    "undefined" != typeof DayPilot.DatePicker && DayPilot.DatePicker.close || (DayPilot.DatePicker = function (t) {
        ...
        this.init = function () {
            ...
            return e && e.addEventListener("input", function () {
                i.date = i.b(),
                i.date && i.navigator.select(i.date, {
                    dontNotify: !0
                })
            }),
        ...
        this.show = function () {
            if (!this.e) {
                ...
                n.weekStarts = "Auto",
                n.locale = i.locale,
                n.onTimeRangeSelected = function (t) {
                    i.date = t.start;
                ...
                "left" === s && (r.style.left = a.x + "px"),
                r.style.top = a.y + o + "px",
                i.zIndex && (r.style.zIndex = i.zIndex);
                var l = document.createElement("div");
                l.id = e,
                r.appendChild(l),
...
"undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function (DayPilot) {
    ...
    if ("undefined" == typeof DayPilot.Menu || !DayPilot.Menu.def) {
            ...
            this.show = function (n, u) {
                ...
                if (n ? "string" == typeof n.id || "number" == typeof n.id ? a = n.id : "function" == typeof n.id ? a = n.id() : "function" == typeof n.value && (a = n.value()) : a = null, "undefined" != typeof DayPilot.Bubble && DayPilot.Bubble.hideActive(), u.submenu || t.menuClean(), this.b.submenu = null, null !== t.mouse) {
                    ...
                    if (n && n.isRow && n.$.row.task ? (s = new DayPilot.Task(n.$.row.task, n.calendar), s.menuType = "resource") : s = n && n.isEvent && n.data.task ? new DayPilot.Task(n, n.calendar) : n, "function" == typeof i.onShow) {
                        ...
                        }, i.onShow(l), l.preventDefault.value)
                            return
                    }
                    ...
                    if (this.showMenuTitle) {
                        var r = document.createElement("div");
                        r.innerHTML = this.menuTitle,
                        r.className = this.c("title"),
                        c.appendChild(r)
                    }
                        ...
                        if (DayPilot.Util.addClass(f, this.c("item")), m.items && (DayPilot.Util.addClass(f, this.c("item_haschildren")), DayPilot.Util.addClass(c, this.c("withchildren"))), "undefined" != typeof m && !m.hidden) {
                            if ("-" === m.text) {
                                ...
                                if (v.style.position = "relative", v.style.display = "block", m.cssClass && DayPilot.Util.addClass(v, m.cssClass), m.disabled)
                                    ...
                                    if (m.onclick || m.onClick) {
                                        ...
                                        v.onclick = function (e, t) {
                                            return function (n) {
                                                if ("function" == typeof e.onClick) {
                                                    ...
                                                    }, e.onClick(i), i.preventDefault.value)
                                                        return
                                                }
                                        ...
                                        var p = function (e, n) {
                                            return function (i) {
                                                ...
                                                if ("function" == typeof e.onClick) {
                                                    ...
                                                    }, e.onClick(u), u.preventDefault.value)
                                                        return void o()
                                                }
                                        ...
                                        DayPilot.reNonPassive(v, "touchstart", function (e) {
                                            e.stopPropagation(),
                                            e.preventDefault(),
                                            v.source.calendar.internal.touch.active = !0
                                        }),
                                ...
                                if (m.symbol) {
                                    ...
                                    x.setAttribute("href", m.symbol),
                                    k.appendChild(x);
                                    var T = document.createElement("span");
                                    T.className = i.c("item_symbol"),
                                    T.style.position = "absolute",
                                    T.style.top = "0px",
                                    T.style.left = "0px",
                                    T.appendChild(k),
                    ...
                    this.addShadow(c),
                    this.b.div = c,
                    u.submenu || (DayPilot.Menu.active = this)
                }
            },
            this.d = function (e, t) {
                var n = e,
                ...
                if ((!i.b.submenu || i.b.submenu.item !== e) && (i.b.submenu && i.b.submenu.item !== e && (DayPilot.Util.removeClass(i.b.submenu.link.parentNode, i.c("item_haschildren_active")), i.b.submenu.menu.hide(), i.b.submenu = null), e.items)) {
                    ...
                    u.items = e.items,
                    i.b.submenu = {},
                    i.b.submenu.menu = new DayPilot.Menu(u),
                    i.b.submenu.menu.f = i,
                    i.b.submenu.menu.show(o, {
                        "submenu": !0,
                        "parentLink": t,
                        "parentItem": n
                    }),
                    i.b.submenu.item = e,
                    i.b.submenu.link = t,
                    DayPilot.Util.addClass(t.parentNode, i.c("item_haschildren_active"))
                }
            },
            this.c = function (e) {
                var t = this.theme || this.cssClassPrefix,
        ...
        t.handlersRegistered || (DayPilot.re(document, "mousemove", t.mouseMove), DayPilot.re(document, "mousedown", t.mouseDown), DayPilot.re(document, "touchmove", t.touchMove), DayPilot.re(document, "touchstart", t.touchStart), DayPilot.re(document, "touchend", t.touchEnd), t.handlersRegistered = !0),
        DayPilot.Menu.def = {}
    }
}
(DayPilot);
"undefined" == typeof DayPilot && (DayPilot = {}), function (DayPilot) {
    ...
    function e(t, a, i) {
        ...
        if ("__proto__" !== o && "constructor" !== o) {
            ...
            d = t[o];
            "object" == typeof d && null !== d || (t[o] = {}, d = t[o]),
            e(d, l, i)
        }
    }
    function t(e, a, i) {
    ...
    if (!DayPilot.ModalStatic) {
        ...
        n.add(".modal_default_form_item", "padding: 10px 0px; position: relative;"),
        n.add(".modal_default_form_item_level1", "border-left: 2px solid #ccc; margin-left: 10px; padding-left: 20px;"),
        n.add(".modal_default_form_item.modal_default_form_title", "font-size: 1.5rem; font-weight: bold;"),
        n.add(".modal_default_form_item input[type=text]", "width: 100%; box-sizing: border-box;"),
        n.add(".modal_default_form_item textarea", "width: 100%; height: 200px; box-sizing: border-box;"),
        n.add(".modal_default_form_item input[type=select]", "width: 100%; box-sizing: border-box;"),
        n.add(".modal_default_form_item label", "display: block;"),
        n.add(".modal_default_form_item select", "width: 100%; box-sizing: border-box;"),
        n.add(".modal_default_form_item_label", "margin: 2px 0px;"),
        n.add(".modal_default_form_item_image img", "max-width: 100%; height: auto;"),
        n.add(".modal_default_form_item_invalid", ""),
        n.add(".modal_default_form_item_invalid_message", "position: absolute; right: 0px; top: 9px; background-color: red; color: #ffffff; padding: 2px; border-radius: 2px;"),
        n.add(".modal_default_background", "opacity: 0.5; background-color: #000;"),
        ...
        n.add(".modal_default_form_item_date:after", "content: ''; position: absolute; right: 7px; top: 50%; margin-top: 3px; width: 10px; height: 15px; background-image:url(" + "data:image/svg+xml;base64," + ")"),
        navigator.userAgent.indexOf("Edge") !== -1 && n.add(".modal_default_form_item_date input::-ms-clear", "display: none;"),
        n.add(".modal_default_form_item_scrollable_scroll", "width: 100%; height: 200px; box-sizing: border-box; border: 1px solid #ccc; overflow-y: auto;"),
        n.add(".modal_default_form_item_scrollable_scroll_content", "padding: 5px;"),
        n.add(".modal_default_form_item_searchable", "position: relative;"),
        n.add(".modal_default_form_item_searchable_icon", ""),
        n.add(".modal_default_form_item_searchable_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + i + ");"),
        n.add(".modal_default_form_item_searchable_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"),
        n.add(".modal_default_form_item_searchable_list_item", "background: white; padding: 2px; cursor: default;"),
        n.add(".modal_default_form_item_searchable_list_item_highlight", "background: #ccc;"),
        n.add(".modal_default_form_item_time", "position: relative;"),
        n.add(".modal_default_form_item_time_icon", ""),
        n.add(".modal_default_form_item_time_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + i + ");"),
        n.add(".modal_default_form_item_time_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"),
        n.add(".modal_default_form_item_time_list_item", "background: white; padding: 2px; cursor: default;"),
        n.add(".modal_default_form_item_time_list_item_highlight", "background: #ccc;"),
        n.add(".modal_default_form_item_datetime_parent", "display: flex;"),
        n.add(".modal_default_form_item_datetime .modal_default_form_item_time_main", "margin-left: 5px;"),
        n.add(".modal_default_form_item_datetime input[type='text'].modal_default_input_date ", ""),
        n.add(".modal_default_form_item_tabular_main", "margin-top: 10px;"),
        n.add(".modal_default_form_item_tabular_table", "display: table; width: 100%; xbackground-color: #fff; border-collapse: collapse;"),
        n.add(".modal_default_form_item_tabular_tbody", "display: table-row-group;"),
        n.add(".modal_default_form_item_tabular_row", "display: table-row;"),
        n.add(".modal_default_form_item_tabular_row.modal_default_form_item_tabular_header", ""),
        n.add(".modal_default_form_item_tabular_cell.modal_default_form_item_tabular_rowaction", "padding: 0px; width: 23px;"),
        n.add(".modal_default_form_item_tabular_cell", "display: table-cell; border: 0px; padding: 2px 2px 2px 0px; cursor: default; vertical-align: bottom;"),
        n.add(".modal_default_form_item_tabular_header .modal_default_form_item_tabular_cell", "padding-left: 0px; padding-bottom: 0px;"),
        n.add(".modal_default_form_item_tabular_table input[type=text], .modal_default_form_item_tabular_table input[type=number]", "width:100%; box-sizing: border-box;"),
        n.add(".modal_default_form_item_tabular_table select", "width:100%; height:100%; box-sizing: border-box;"),
        n.add(".modal_default_form_item_tabular_plus", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"),
        n.add(".modal_default_form_item_tabular_plus:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"),
        n.add(".modal_default_form_item_tabular_delete", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"),
        n.add(".modal_default_form_item_tabular_delete:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"),
        n.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_plus", "display: none;"),
        n.add(".modal_default_form_item_tabular_plus_max.modal_default_form_item_tabular_plus", "display: none;"),
        n.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_delete", "visibility: hidden;"),
        n.add(".modal_default_form_item_tabular_empty", "height: 1px; margin: 5px 23px 5px 0px; background-color: #ccc;"),
        n.add(".modal_default_form_item_tabular_spacer .modal_default_form_item_tabular_cell", "padding: 0px;"),
        ...
        n.add(".navigator_modal_main", "border-left: 1px solid #c0c0c0;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;background-color: white;color: #000000; box-sizing: content-box;"),
        n.add(".navigator_modal_main *, .navigator_modal_main *:before, .navigator_modal_main *:after", "box-sizing: content-box;"),
        ...
        n.add(".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright", "border-top: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;color: #333;background: #f3f3f3;"),
        n.add(".navigator_modal_busy", "font-weight: bold;"),
        n.add(".navigator_modal_cell", "text-align: center;"),
        n.add(".navigator_modal_select .navigator_modal_cell_box", "background-color: #FFE794; opacity: 0.5;"),
        n.add(".navigator_modal_title", "text-align: center;"),
        n.add(".navigator_modal_titleleft, .navigator_modal_titleright", "text-align: center;"),
        ...
        DayPilot.Modal = function (e) {
            ...
            this.showUrl = function (e) {
                ...
                if (this.useIframe) {
                    ...
                    a && (this.iframe.src = "about:blank", this.setInnerHTML(this.id + "iframe", a)),
                    this.re(this.iframe, "load", this.h),
                    this.iframe.src = e,
                    this.e(),
                    this.f(),
                    this.g()
            ...
            this.s = function () {
                this.ue(window, "resize", this.o),
                this.ue(window, "scroll", this.p),
                this.dragDrop && (this.ue(document, "mousemove", this.q), this.ue(document, "mouseup", this.r)),
                this.a = !1
            },
            this.t = function (e) {
            ...
            this.q = function (e) {
                if (t.c) {
                    ...
                    t.div.style.top = t.b.y + n + "px",
                    t.div.style.left = t.b.x + i + "px"
                }
            },
            this.r = function (e) {
            ...
            this.d = function () {
                ...
                var l = null;
                this.useIframe && (l = document.createElement("iframe"), l.id = this.id + "iframe", l.name = this.id + "iframe", l.frameBorder = "0", l.style.width = "100%", l.style.height = "50px", o.appendChild(l)),
                e.appendChild(o),
                this.div = o,
                this.iframe = l,
                this.hideDiv = n
            ...
            this.setInnerHTML = function (e, a) {
                ...
                a.nodeType ? n.body.appendChild(a) : n.body.innerHTML = a,
            ...
            this.hide = function (e) {
                e = e || {};
                var a = {};
                a.backgroundClick = !!e.backgroundClick,
                a.result = this.result,
                a.canceled = "undefined" == typeof this.result,
        ...
        DayPilot.Modal.prompt = function (e, t, a) {
            "object" == typeof t && (a = t, t = ""),
            a = a || {},
            a.height = a.height || 40,
            a.useIframe = !1;
            var i = a.okText || "OK",
        ...
        DayPilot.Modal.Experimental.Form = l,
        ...
        l.prototype.createView = function (e) {
            ...
            o.H = i,
            o.row = e,
            o.element && i.appendChild(o.element),
            this.G.push(o),
        ...
        l.prototype.createInteractive = function (e) {
            ...
            a = {
                ...
                "html": function () {
                    var t = new r,
                    a = document.createElement("div");
                    return "string" == typeof e.data.text ? a.innerText = e.data.text : "string" == typeof e.data.html && (a.innerHTML = e.data.html),
                    t.element = a,
                    t
                },
                "scrollable": function () {
                    ...
                    var n = document.createElement("div");
                    return n.className = t.theme + "_form_item_scrollable_scroll_content",
                ...
                "text": function () {
                    ...
                    a.focus = function () {
                        a.element.focus(),
                        a.element.setSelectionRange(0, a.element.value.length)
                    },
                    a.save = function () {
                        var t = {};
                ...
                "textarea": function () {
                    ...
                    a.focus = function () {
                        a.element.focus(),
                        a.element.setSelectionRange(0, 0)
                    },
                    a.save = function () {
                        var t = {};
                        return t[e.field] = i.value,
        ...
        l.prototype.K = function (e) {
            ...
            for (var o = 60 / n, l = e.data.locale || t.locale, d = DayPilot.Locale.find(l) || DayPilot.Locale.US, c = DayPilot.Date.today(), u = 0; u < 24 * o; u++) {
                ...
                h = {};
                h.name = m.toString(e.data.timeFormat || d.timePattern, d),
                h.id = m.toString("HH:mm"),
                i.push(h)
            }
            var p = new s({
                data: i,
        ...
        l.prototype.L = function (e) {
            ...
            a.apply = function (e) {
                ...
                if (d) {
                    ...
                    l.locale = d,
                    l.pattern = r.datePattern
                }
                o.disabled = !e.enabled,
                l.date = new DayPilot.Date(e.value);
            ...
            n = function () {
                ...
                for (var o = 60 / n, l = e.data.locale || t.locale, d = DayPilot.Locale.find(l) || DayPilot.Locale.US, r = DayPilot.Date.today(), c = 0; c < 24 * o; c++) {
                    ...
                    m = {};
                    m.name = u.toString(e.data.timeFormat || d.timePattern, d),
                    m.id = u.toString("HH:mm"),
                    i.push(m)
                }
                var h = new s({
                    data: i,
                ...
                return a.searchable = h,
                h.create()
            }
            (),
            o = document.createElement("div");
            return o.className = t.theme + "_form_item_datetime_parent",
            o.appendChild(i),
            o.appendChild(n),
            a.element = o,
            a.canFocus = function () {
        ...
        s = function (e) {
            ...
            Object.defineProperty(this, "disabled", {
                ...
                set: function (e) {
                    this.N = e,
                    this.R && (this.R.disabled = e, e && this.V())
                }
            });
            for (var i in e)
                a[i] || (this[i] = e[i]);
        ...
        s.prototype.create = function () {
            function e(e) {
                var a = r.strategy;
                "includes" !== r.strategy && "startsWith" !== r.strategy && (a = "includes"),
                e = e || a || "includes",
                m.style.display = "",
                ...
                r.data.forEach(function (a) {
                    ...
                    if ("includes" === e) {
                        ...
                        return;
                    var l = document.createElement("div");
                    l.className = r.theme + "_list_item",
                    l.innerText = o,
                    l.item = a,
                    a === r.O && (r.P = l),
                    n || (n = l),
            ...
            var m = document.createElement("div");
            m.className = this.theme + "_list",
            m.style.display = "none",
            m.style.position = "absolute",
            m.style.zIndex = this.listZIndex;
            ...
            this.R = p,
            this.S = m,
            this.O || (this.O = this.data[0], this.O && (p.value = this.O.name)),
            c.appendChild(p),
            c.appendChild(u),
            c.appendChild(h),
            c.appendChild(m),
        ...
        s.prototype.V = function () {
            this.X(),
            this.O ? this.R.value = this.O.name : (this.R.value = "", this.W(!0))
        },
        s.prototype.focus = function () {
            this.Q = !0,
            this.R.setAttribute("readonly", "readonly"),
            this.R.focus(),
            this.V()
        },
        ...
        c.prototype.create = function () {
            ...
            o.spacer = !0;
            var l = this._(o);
            l.classList.add(e.theme + "_spacer"),
            i.appendChild(l);
            var d = document.createElement("div");
            d.className = e.theme + "_tbody",
            i.appendChild(d),
            t.appendChild(i);
            var r = document.createElement("div");
            t.appendChild(r),
        ...
        c.prototype.Z = function () {
            ...
            this.item.columns.forEach(function (a) {
                var i = document.createElement("div");
        ...
        c.prototype.ea = function () {
            ...
            this.ca() ? this.nav.plus.classList.add(this.theme + "_plus_max") : this.nav.plus.classList.remove(this.theme + "_plus_max")
        },
        ...
        c.prototype.ia = function (e) {
            ...
            if ("text" === a || "number" === a) {
                ...
                i.addEventListener("keyup", function (i) {
                    "number" === a ? e.value = Number(this.value) : e.value = this.value,
                    t.ba()
                }),
                i
            }
            if ("select" === a) {
                ...
                e.data.options.forEach(function (t) {
                    ...
                    a.M = t.id,
                    n.appendChild(a),
                    e.value === t.id && a.setAttribute("selected", !0)
                }),
                n.addEventListener("change", function (a) {
                    var i = n.options[n.selectedIndex];
                    i && "undefined" != typeof i.M && (e.value = i.M),
                    t.ba()
                }),
                n
            }
        ...
        t.Month = function (e, i) {
            ...
            this.events.load = function (t, e, i) {
                ...
                a = function (t) {
                    ...
                    if (DayPilot.isArray(i)) {
                        ...
                        if (o.preventDefault = function () {
                            this.preventDefault.value = !0
                        }, o.data = i, "function" == typeof e && e(o), o.preventDefault.value)
                            return;
                        n.events.list = i,
                        n.k && n.update()
                    }
            ...
            this.drawShadow = function (e, i, n, s, a, l) {
                ...
                for (t.resizingEvent ? c = "w-resize" : t.movingEvent && (c = "move"), this.nav.top.style.cursor = c; o > 0 && i < this.rows.length; ) {
                    ...
                    p.style.width = this.getCellWidth() * d + "%",
                    p.style.top = u + "px",
                    p.style.height = f + "px",
                    p.style.cursor = c;
            ...
            this.getEventTop = function (t, e) {
                ...
                return i += this.cellHeaderHeight,
                i += e * this.lineHeight()
            },
            ...
            this.t = function (e) {
                ...
                c = this.getEventTop(s, a),
                d = document.createElement("div");
                d.setAttribute("unselectable", "on"),
                d.style.height = this.eventHeight + "px",
                d.className = this.u("_event"),
                i.cssClass && DayPilot.Util.addClass(d, i.cssClass),
                e.part.startsHere || DayPilot.Util.addClass(d, this.u("_event_continueleft")),
                e.part.endsHere || DayPilot.Util.addClass(d, this.u("_event_continueright")),
                d.event = e,
                d.style.width = h + "%",
                d.style.position = "absolute",
                d.style.left = r + "%",
                d.style.top = c + "px",
                this.showToolTip && e.client.toolTip() && (d.title = e.client.toolTip()),
                d.onclick = n.w,
                d.oncontextmenu = n.z,
                d.onmousedown = function (i) {
                    ...
                    if (i.cancelBubble = !0, i.stopPropagation && i.stopPropagation(), 1 === r)
                        if (t.movingEvent = null, "w-resize" === this.style.cursor || "e-resize" === this.style.cursor) {
                            ...
                            p.start.y = s,
                            p.start.line = a,
                            p.offset = n.eventMoveToPosition ? 0 : f,
                            p.colWidth = o,
                            p.event = d.event,
                            p.coords = c,
                            t.movingEvent = p
                ...
                d.onmouseleave = function (t) {
                    d.deleteIcon && (d.deleteIcon.style.display = "none"),
                    d.style.cursor = ""
                },
            ...
            this.B = function () {
                ...
                e.onmousemove = function (e) {
                    if (t.resizingEvent) {
                        ...
                        a = n.cellMode ? 1 : DayPilot.DateUtil.daysSpan(c.start(), c.end()) + 1;
                        a < 1 && (a = 1),
                        n.drawShadow(s.x, s.y, 0, a, d, c)
                        ...
                        n.drawShadow(f.x, f.y, 0, a, 0, null)
                    }
                }
            },
            this.h = function () {
            ...
            this.C = function (e, i, a) {
                ...
                c.style.top = "0px",
                c.style.bottom = "0px",
                c.className = this.u("_cell_inner"),
                ...
                var d = document.createElement("div");
                d.setAttribute("unselectable", "on"),
                d.style.height = this.cellHeaderHeight + "px",
                d.className = this.u("_cell_header"),
                ...
                var v = o.getDay();
                1 === v ? d.innerHTML = s.locale().monthNames[o.getMonth()] + " " + v : d.innerHTML = v,
                c.appendChild(d),
                this.cells[e][i] = r,
                a.appendChild(r)
            },
            ...
            this.F = function (t, e, i) {
                ...
                this.backendUrl && DayPilot.request(this.backendUrl, this.H, s, this.ajaxError)
            },
            this.H = function (t) {
                n.a(t.responseText)
            },
            ...
            this.eventClickSingle = function (t, e) {
                ...
                if (i.client.clickEnabled())
                    if (n.D()) {
                        var s = {};
                        if (s.e = i, s.control = n, s.div = t, s.originalEvent = e, s.meta = e.metaKey, s.ctrl = e.ctrlKey, s.preventDefault = function () {
                            this.preventDefault.value = !0
            ...
            this.I = function (t) {
                ...
                if (e.e = t, e.preventDefault = function () {
                    ...
                    return "function" == typeof n.onEventRightClicked && n.onEventRightClicked(e),
                    !1
                }
            },
            this.A = function (t) {
            ...
            this.K = function (t, e, i, s, a, l) {
                ...
                if (n.D()) {
                    var p = {};
                    if (p.e = t, p.control = n, p.newStart = u, p.newEnd = f, p.ctrl = a.ctrlKey, p.shift = a.shiftKey, p.preventDefault = function () {
                        this.preventDefault.value = !0
            ...
            this.isWeekend = function (t) {
                return t = new DayPilot.Date(t),
                0 === t.dayOfWeek() || 6 === t.dayOfWeek()
            },
            this.M = {},
            ...
            this.internal = {},
            this.internal.loadOptions = this.l,
            this.internal.xssTextHtml = n.R,
            this.init = function () {
                return this.P(),
                this.loadFromServer() ? void this.Q() : (this.c(), this.d(), this.B(), this.g(), this.m(), this.i(), this.O(), this.fireAfterRenderDetached(null, !1), this.k = !0, this)
            },
            this.Init = this.init,
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
        DayPilot.Navigator = function (t, e) {
            ...
            this.b = function () {
                ...
                "Horizontal" === this.orientation ? (this.root.style.width = this.showMonths * (7 * a.cellWidth() + this.d()) + "px", this.root.style.height = 6 * this.cellHeight + this.titleHeight + this.dayHeaderHeight + "px") : this.root.style.width = 7 * a.cellWidth() + this.d() + "px",
            ...
            this.i = function (t, e) {
                ...
                for (var M = 0; M < 7; M++) {
                    ...
                    var H = document.createElement("div");
                    H.style.position = "absolute",
                    H.style.left = M * a.cellWidth() + w + "px",
                    H.style.right = M * a.cellWidth() + w + "px",
                    ...
                    H.innerHTML = "<span>" + this.l(M) + "</span>",
                    v.appendChild(H),
                    s.days.push(H);
                    for (var k = 0; k < u; k++) {
                        ...
                        R.onclick = this.p,
                        v.appendChild(R),
                        P && (i.q(v, M, k), this.selected.push(R))
                    }
                }
                var V = document.createElement("div");
            ...
            this.t = function () {
                ...
                t.selectionStart = i.selectionStart,
                t.selectionEnd = i.selectionEnd.addDays(1),
                i.state.value = JSON.stringify(t)
            },
            this.n = function () {
            ...
            this.u = function () {
                ...
                case "week":
                    this.selectionDay = t,
                    this.selectionStart = t.firstDayOfWeek(a.weekStarts()),
                    this.selectionEnd = this.selectionStart.addDays(6);
                    break;
                case "month":
                    this.selectionDay = t,
                    this.selectionStart = t.firstDayOfMonth(),
            ...
            this.select = function (t, e, s) {
                ...
                u = this.selectionEnd;
                this.selectionStart = new DayPilot.Date(l).getDatePart(),
                this.selectionDay = this.selectionStart;
                var f = !1;
                if (r) {
                    var y = this.startDate;
                    (this.selectionStart < this.A() || this.selectionStart >= this.B()) && (y = this.selectionStart.firstDayOfMonth()),
                    y.toStringSortable() !== this.startDate.toStringSortable() && (f = !0),
                    this.startDate = y
                }
            ...
            this.update = function (t) {
                if (i.F(t), this.z) {
                    ...
                    i.I(),
                    e.start === i.selectionStart && e.end == i.selectionEnd && e.day === i.selectionDay || i.D()
                }
            },
            this.I = function () {
                this.f(),
            ...
            this.N = function () {
                ...
                t.selectionStart = this.selectionStart,
                t.showMonths = this.showMonths,
                t
            },
            this.S = function (t, e) {
                "refresh" === t && this.E()
            ...
            this.V = function (t) {
                if (i.freeHandSelectionEnabled) {
                    var e = i.U(t);
                    e && !e.header && (s.start = e),
                    i.months[e.month].cells[e.x][e.y],
                    t.preventDefault()
                }
            },
            this.W = function (t) {
            ...
            s.ordered = function () {
                ...
                e = s.end,
                i = {};
                return !e || new n(t).before(e) ? (i.start = t, i.end = e) : (i.start = e, i.end = t),
                i
            };
            ...
            this.p = function (t) {
                ...
                if (s.cells[n][a].isClickable) {
                    ...
                    case "day":
                        ...
                        i.q(e, n, a),
                        i.selected.push(h),
                        i.selectionStart = h.day,
                        i.selectionEnd = h.day;
                        break;
                    case "week":
                        if (i.autoFocusOnClick) {
                        ...
                        i.selectionStart = s.cells[0][a].day,
                        i.selectionEnd = s.cells[6][a].day;
                        break;
                    case "month":
                        if (i.autoFocusOnClick) {
                            var o = l;
                ...
                if (t = t || {}, i.e()) {
                    ...
                    case "Bind":
                        if ("object" == typeof bound) {
                            ...
                            o.days = n,
                            o.day = a,
                            bound.commandCallBack(i.command, o)
                        }
                        break;
                    case "None":
                        break;
            ...
            this.Z = function (t) {
                ...
                "Horizontal" === this.orientation && (e.right = t === this.showMonths - 1),
                e
            },
            this._ = {},
            this._.scope = null,
            ...
            this.init = function () {
                if (this.ea(), !this.root.dp) {
                    ...
                    if (this.ca() && this.E(), this.z = !0, this.L(), this.w) {
                        var t = this.w;
                        this.select(t.date1, t.date2, t.options),
                        this.w = null
                    }
                    return this
                }
            ...
            this.ga = function () {
                i.nav.top.onmousedown = this.V,
                i.nav.top.onmousemove = this.W
            },
            this.ha = function () {
